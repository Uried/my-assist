  ...
  async createDemoData(force = false) {
    ...
    const courriers = [
      ...
      },
      {
        ...
        expediteur: 'Marie-Claire Mbarga',
    ...
    const contacts = [
      {
        ...
        nom: 'Nkodo',
        prenom: 'Jean-Pierre',
        organisation: 'Cameroon Telecom',
        fonction: 'Directeur',
        telephone: '237699123456',
        email: 'jean-pierre.nkodo@camtel.cm',
      ...
      },
      {
        ...
        email: 'marie-claire.mbarga@sonara.cm',
        adresse: 'Avenue Kennedy, Douala',
      ...
      },
      {
        ...
        fonction: 'Directrice',
        telephone: '237633456789',
        email: 'sophie.mengue@partner.cm',
      ...
      },
      {
        ...
        nom: 'Tchoumi',
        prenom: 'Lucas',
        organisation: 'MTN Cameroon',
        fonction: 'Commercial',
        telephone: '237611567890',
        email: 'lucas.tchoumi@mtn.cm',
        adresse: 'Boulevard de la Réunification, Yaoundé',
        typeContact: 'fournisseur',
        notes: ''
      }
    ];
    ...
    const documents = [
      {
        ...
        titre: 'Contrat type',
        categorie: 'Juridique',
        description: 'Modèle de contrat client selon le droit camerounais',
      ...
      },
      {
        ...
        description: 'Modèle de devis pour les clients camerounais',
